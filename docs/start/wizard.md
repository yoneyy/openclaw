...
Ollama Web Search, Perplexity, SearXNG, SenseAudio, or Tavily. Some providers
require an API key, while others are key-free. You can also configure this later with
